...
This project extends Lab 4 with AI integration tasks. Variant implementations are under `variants/`.

Current implemented variant:
- `variants/variant-19`: participant registration service with Amazon Comprehend language analysis.
...
`backend.hcl` is ignored by Git via `.gitignore`.
